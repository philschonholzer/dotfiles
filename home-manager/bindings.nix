inputs: {
  ...
  wayland.windowManager.hyprland.settings = {
    bind = lib.mkForce [
      ...
      "SUPER, A, exec, $terminal --working-directory=/home/philip/ai-temp -e opencode"
      ...
      "SUPER, D, exec, nautilus --new-window ~/Downloads"
      ...
      "SUPER SHIFT, slash, exec, ~/.local/share/omarchy/bin/omarchy-show-keybindings"

      # Control tiling
      "SUPER, backslash, togglesplit, # dwindle"
